				...
				<div class="row">
							...
							<div id="myTabContent1" class="tab-content clearfix">
								<div class="tab-pane fade active in" id="Popular">
								   <p align="left"><img src="images/ceo.jpg" width="325" height="400" border="0"></p>
									<p align="justify"><b>Shri. Mangesh Phadtare.<br>
									CEO</b></p>
								</div>
							</div>
					...
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						<div class="blog_large">
							<p align="justify">	
								I welcome your interest in DKKKP <b><i>"Education to all"</i></b> is our dream.<br>
								"If you have infinite patience and preseverance,success is bound to come."
							</p>
						</div>
					</div>
